...
spawn(function()
    while screenGui do
        for i = 1, 6 do
            if i == 1 then mainStroke.Color = Color3.new(1, 0, 0)
            elseif i == 2 then mainStroke.Color = Color3.new(1, 1, 0)
            elseif i == 3 then mainStroke.Color = Color3.new(0, 1, 0)
            elseif i == 4 then mainStroke.Color = Color3.new(0, 1, 1)
            elseif i == 5 then mainStroke.Color = Color3.new(0, 0, 1)
            elseif i == 6 then mainStroke.Color = Color3.new(1, 0, 1)
            end
            task.wait(0.5)
        end
    end
